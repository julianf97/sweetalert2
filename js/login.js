...
btnJoinFree.addEventListener("click", () => {
    ...
    Swal.fire({
        html: '<div class="contenedor-cruz-alert"><div class="contenedor-icono-cruz-alert"><button id="botonSalirFormularioalert"><i class="fa-solid fa-xmark"></i></button></div></div>' +
        '<div class="contenedor-logo-alert"><img src="../img/logo.png"></div>' + 
